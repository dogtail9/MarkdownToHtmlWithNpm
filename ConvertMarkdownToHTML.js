...
var minPort = 1000;
var maxPort = 1998;
var myPort = 9090;//Math.floor(Math.random() * (maxPort - minPort + 1) + minPort);
        ...
        fs.readFile(filename, function (err, data) {
            ...
            if (data) {
                ...
                img64.encodeImgs(html, { baseDir: p }, function (err, data) {
                    ...
                    htmlWithImg64 = template.replace('@@@HTML@@@', data);
                    htmlWithImg64 = htmlWithImg64.replace('@@@BuildName@@@', BuildNumber);
                    htmlWithImg64 = htmlWithImg64.replace('.md', '.html');

console.log(htmlWithImg64);
